...
$route['album/images/(:num)']['DELETE'] = 'album_images/delete/$1';
$route['album/images/(:num)']['GET'] = 'album_images/get/$1';
$route['album/images']['GET'] = 'album_images/get';
$route['album/images']['POST'] = 'album_images/add';
$route['album/images/(:num)']['PUT'] = 'album_images/update/$1';
...
$route['memcached/(:any)']['DELETE'] = 'cache/delete/$1';
...
// resized photos
$route['resized/(:num)']['DELETE'] = 'resized/delete/$1';
$route['resized/(:num)']['GET'] = 'resized/get/$1';
$route['resized']['GET'] = 'resized/get';
$route['resized']['POST'] = 'resized/add';
$route['resized/(:num)']['PUT'] = 'resized/update/$1';
